...
describe('Disccrete Axis test', () => {
  ...
  test('it should rotate tick text on bottom axis if text width is more than width of rectangles', () => {
    ...
    expect(elements[0]).toHaveAttribute('transform', "translate(51.53086419753081, 666), rotate(-90)");
    expect(elements[2]).toHaveAttribute('transform', 'translate(224.37037037037032, 666), rotate(-90)');
  })
  ...
  test('it should correctly position tick text on bottom axis', () => {
    ...
    const elements = screen.queryAllByTestId('d3reactor-ticktext');
    expect(elements[0]).toHaveAttribute('transform', "translate(74.69135802469125, 1082)");
    expect(elements[4]).toHaveAttribute('transform', "translate(617.9012345679012, 1082)");
  })
  ...
  test('it should correctly position tick text on top axis', () => {
    ...
    const elements = screen.queryAllByTestId('d3reactor-ticktext');
    expect(elements[0]).toHaveAttribute('transform', "translate(74.69135802469125, -8)");
    expect(elements[4]).toHaveAttribute('transform', "translate(617.9012345679012, -8)");
  });
})